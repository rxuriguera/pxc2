 ...
 * system. Also provides functionality for converting messages to/from byte
 * arrays in a portable manner. The type of every message is a 4-byte value
 * (i.e. 4-character string).
 * 
...
public class PeerMessage {
	...
	/**
	 * Constructs a new PeerMessage object by reading data from the given socket
	 * connection.
	 * 
	 * @param s
	...
	/*
	 * Taken from
	 * http://forum.java.sun.com/thread.jspa?threadID=609364&messageID=3336342
	 */
	/**
	...
	public static int byteArrayToInt(byte[] byteArray) {
		...
		// byteArray[1], byteArray[2], byteArray[3], integer);
