...
/**
 * Maintains information related to the location of a peer node in the system,
 * along with the peer's (unique) identifier in the peer-to- peer network.
 * 
...
public class PeerInfo implements Serializable {
	...
	private static final long serialVersionUID = -5595406747480849004L;
	 ...
	 * 
	 * @param id
	 *            this peer's (unique) identifier in the peer-to-peer system
	 * @param host
	 *            the IP address
	 * @param port
	 *            the TCP port number
	...
	/**
	 * Creates and initializes a new PeerInfo object, with the peer's identifier
	 * set to "host:port".
	 * 
	 * @param host
	 *            the IP address
