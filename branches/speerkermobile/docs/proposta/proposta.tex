...
\item{}Assignat a: Héctor i Ramon
\newline
\end{itemize}
...
\item{}Assignat a: Jordi i Héctor
\newline
\end{itemize}
...
Tal i com es pot intuir a partir del diagrama de Gantt, els rols dels membres de l'equip són:
\begin{itemize}
\item{Jordi Bartrolí: Streaming i dispositius mòbils}
\item{Héctor Mañosas: Base de Dades i comunicació amb el servidor}
